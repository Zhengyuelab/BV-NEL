...
| OCP averaging window | final 1 s | `OCP_AVERAGE_WINDOW_MS` |
...
| Coarse scan potentials | E<sub><i>initial</i></sub> − 100 mV, E<sub><i>initial</i></sub>, E<sub><i>initial</i></sub> + 100 mV | `COARSE_OFFSETS_MV` |
| Fine scan range | E<sub><i>prelim</i></sub> ± 10 mV | `FINE_RANGE_MV` |
| Fine scan step | 5 mV | `FINE_STEP_MV` |
| Fine scan points | 5 | E<sub><i>prelim</i></sub> −10, −5, 0, +5, +10 mV |
